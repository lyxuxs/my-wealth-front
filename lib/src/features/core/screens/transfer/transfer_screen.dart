...
class _TransferScreenState extends State<TransferScreen> {
  ...
  Future<void> fetchTransList() async {
    ...
    walletList = Wallet(
        jsonDecode(prefs.getString('userDetails').toString())["spotBalance"],
        jsonDecode(
            prefs.getString('userDetails').toString())["fundingBalance"]);
  }
                        ...
                        child: GestureDetector(
                          onTap: () {
                            setState(() {
                              ...
                              if (text1 == 'Spot') {
                                selectedWalletValue =
                                    walletList.spotWalletValue;
                                selectedWalletText = 'Spot Wallet';
                              } else if (text1 == 'Funding') {
                                selectedWalletValue =
                                    walletList.fundingWalletValue;
                                selectedWalletText = 'Funding Wallet';
                              }
                            });
                          },
